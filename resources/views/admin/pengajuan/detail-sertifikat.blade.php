    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card p-3">
                ...
                <form action="{{ route('admin.pengajuan-sertifikat.update', $pengajuan->id_pengajuan) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.pengajuan-sertifikat.index') }}" class="btn btn-secondary">
                            Batal
                        </a>
                    </div>
                </form>
